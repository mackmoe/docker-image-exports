...
```
docker-compose --project-name mattermost-app -f docker-compose.yml up -d
```

However
---
If it's the first time you're running the compose script for this docker app stack, you mush run the following cmds 1st!
